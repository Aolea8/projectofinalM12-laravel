...
use App\Http\Controllers\Api\PeliController;
...
Route::post('/videos', [PeliController::class, 'store'])->middleware(['auth:sanctum']);
Route::put('/videos/{peli}', [PeliController::class, 'update'])->middleware(['auth:sanctum']);
Route::delete('/videos/{peli}', [PeliController::class, 'destroy'])->middleware(['auth:sanctum']);
Route::get('/videos', [PeliController::class, 'index'])->middleware(['auth:sanctum']);
Route::get('/videos/{peli}', [PeliController::class, 'show'])->middleware(['auth:sanctum']);
